...
<head>
  ...
  <!-- PLUGINS CSS STYLE -->
  <link rel="stylesheet" href="{{assest('apps/plugins/bootstrap/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{assest('apps/plugins/themify-icons/themify-icons.css')}}">
  <link rel="stylesheet" href="{{assest('apps/plugins/slick/slick.css')}}">
  <link rel="stylesheet" href="{{assest('apps/plugins/slick/slick-theme.css')}}">
  <link rel="stylesheet" href="{{assest('apps/plugins/fancybox/jquery.fancybox.min.css')}}">
  <link rel="stylesheet" href="{{assest('apps/plugins/aos/aos.css')}}">

  <!-- CUSTOM CSS -->
  <link href="{{assest('apps/css/style.css')}}" rel="stylesheet">
...
<footer>
  ...
  <!-- JAVASCRIPTS -->
  <script src="{{assest ('apps/plugins/jquery/jquery.min.js')}}"></script>
  <script src="{{assest ('apps/plugins/bootstrap/bootstrap.min.js')}}"></script>
  <script src="{{assest ('apps/plugins/slick/slick.min.js')}}"></script>
  <script src="{{assest ('apps/plugins/fancybox/jquery.fancybox.min.js')}}"></script>
  <script src="{{assest ('apps/plugins/syotimer/jquery.syotimer.min.js')}}"></script>
  <script src="{{assest ('apps/plugins/aos/aos.js')}}"></script>
  <!-- google map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
  <script src="{{assest ('apps/plugins/google-map/gmap.js')}}"></script>
