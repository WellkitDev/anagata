	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				...
				<p class="text-white mb-5">Anagata Education: Research and Publishing adalah lembaga publikasi jurnal terpercaya dan professional.</p>
				<a href="404.html" class="btn btn-main-md">PUBLISHING NOW</a>
			</div>
...
<section class="section pt-0 position-relative pull-top" id="about">
	<div class="container">
		<div class="rounded shadow p-5 bg-white">
			<h3 class="text-center">Kami menyediakan layanan publikasi jurnal dengan kualitas yang baik! <br>dengan tahapan sebagai berikut:</h3>
			<div class="row mt-4">
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					<i class="ti-comments text-primary h1"></i>
					<h3 class="mt-4 text-capitalize h5 ">Konsultasi</h3>
					<p class="regular text-muted">Konsultasikan dengan staff kami apa yang Anda cari dan apa kemauan Anda!</p>
				</div>
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					<i class="ti-cloud-up text-primary h1"></i>
					<h3 class="mt-4 text-capitalize h5 ">Proses Publikasi</h3>
					<p class="regular text-muted">Kami akan memproses publikasi jurnal Anda sesuai estimasi waktu yang akan diberikan!</p>
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto align-self-center">
				<div class="feature-content">
					<!-- Feature Title -->
					<h2>Publish your articles with <a
							href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Hafasy Journal</a></h2>
					<!-- Feature Description -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 ml-auto align-self-center">
				<div class="feature-content">
					<!-- Feature Title -->
					<h2>Publish your articles <a
							href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Nawala Education</a></h2>
					<!-- Feature Description -->
...
=            Services            =
===============================-->
<section class="service section bg-gray" id="service">
